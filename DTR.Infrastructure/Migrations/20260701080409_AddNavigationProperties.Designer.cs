...
namespace DTR.Infrastructure.Migrations
{
    ...
    [Migration("20260701080409_AddNavigationProperties")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DTR.Domain.Entities.AttendanceRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DTR.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DTR.Domain.Entities.AttendanceRecord", b =>
                {
                    b.HasOne("DTR.Domain.Entities.User", "ApprovedByAdmin")
                        .WithMany()
                        .HasForeignKey("ApprovedByAdminId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DTR.Domain.Entities.User", "Student")
